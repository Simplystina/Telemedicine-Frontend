...
function TestimonialCard({ testimonial, name, location, image }: TestimonialProps) {
    return (
        <div className="w-[374px] h-[261px] bg-white rounded-2xl shadow-[0px_0px_2px_rgba(23,26,31,0.12),0px_4px_9px_rgba(23,26,31,0.11)] p-6 animate-slide-in-right hover:shadow-[0px_0px_4px_rgba(23,26,31,0.15),0px_6px_12px_rgba(23,26,31,0.14)] transition-shadow duration-300 flex flex-col justify-between">
