            ...
            <div className="w-full">
                ...
                <div className="relative">
                    <input
                        ...
                        className={`w-full px-4 py-3 pr-12 border ${error ? 'border-red-500' : 'border-neutral-300'
                    ...
                    <button
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-500 hover:text-neutral-700 transition-colors focus:outline-none"
                        tabIndex={-1}
                    >
                        {showPassword ? (
